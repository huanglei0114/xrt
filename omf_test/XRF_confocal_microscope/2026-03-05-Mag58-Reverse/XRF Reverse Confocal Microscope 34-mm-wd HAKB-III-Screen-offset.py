...
def build_beamline(field_z = 0e-3, scr_offset = 0e-3): # field size in z direction
    ...
    beamLine.mask1 = rapts.RectangularAperture(
        ...
        name=r"Mask",
        center=[0, 0, 0],
        opening=[-10.0, 10.0, -ca / 2 * 1.2, ca / 2],
        x=[1.0, 0.0, 0.0],
        z=[0.0, 0.0, 1.0],
    )
...
def run_process(beamLine):
    ...
    mask1_local = beamLine.mask1.propagate(beam=geometricSource01beamGlobal01)
    ...
    screen01beamLocal01 = beamLine.screen.expose(beam=m2Param01beamGlobal01)
...
def main():
    ...
    fig_path = os.path.join(
        script_dir, "XRF Reverse Confocal Microscope 34-mm-wd HAKB-III-Screen-offset.png"
    )
